...
interface S3Service {
  ...
  upload(bucket: string, key: string, tags: Record<string, string>, file: stream.Readable, contentType: string): Promise<void>;
}
...
export default fp(async (fastify) => {
  ...
  const s3Service: S3Service = {
    ...
    async upload(bucket: string, key: string, tags: Record<string, string>, file: stream.Readable, contentType: string) {
