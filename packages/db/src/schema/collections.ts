import { pgTable, text, timestamp, jsonb, primaryKey, foreignKey, integer } from "drizzle-orm/pg-core";
...
export const collectionAuthors = pgTable("collection_authors", {
    ...
    primaryKey({ columns: [table.collectionSlug, table.collectionLocale, table.authorSlug] }),
    foreignKey({
...
export const collectionAuthorsRelations = relations(collectionAuthors, ({ one }) => ({
    collection: one(collections, {
        fields: [collectionAuthors.collectionSlug, collectionAuthors.collectionLocale],
...
export const collectionChaptersRelations = relations(collectionChapters, ({ one }) => ({
    collection: one(collections, {
