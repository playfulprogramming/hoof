import { mockEndpoint, server } from "test-utils/server.ts";
...
test("should fetch page HTML", async () => {
	...
	// TODO: this is temporary debugging for MSQ
	// - the "https://example.com/test" request handler is logged here, but the actual request throws an unhandled error
